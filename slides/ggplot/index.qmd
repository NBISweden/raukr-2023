...
::: {.aside}
[Anscombe's quartet](https://en.wikipedia.org/wiki/Anscombe%27s_quartet), [Datasaurus](https://www.autodesk.com/research/publications/same-stats-different-graphs)  
:::
...
![](assets/scientific_paper_graph_quality.jpg)
...
::: {.aside}
[Source: xkcd](https://xkcd.com/1945/)
:::
...
:::: {.columns}
::: {.column width="50%"}
```{r,bag-1,fig.height=5,fig.width=5,eval=FALSE}
data(iris)
ggplot(iris)
```
:::
...
::: {.column width="50%"}
```{r,bag-1,fig.height=5,fig.width=5,echo=FALSE}
```
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
```{r,bag-2,fig.height=5,fig.width=5,eval=FALSE,echo=TRUE}
ggplot(iris,aes(x=Sepal.Length,
                y=Sepal.Width))
```
:::
...
::: {.column width="50%"}
```{r,bag-2,fig.height=5,fig.width=5,echo=FALSE}
```
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
```{r,bag-3,fig.height=5,fig.width=5,eval=FALSE,echo=TRUE}
ggplot(iris,aes(x=Sepal.Length,
                y=Sepal.Width))+
  geom_point()
```
...
::: {.column width="50%"}
```{r,bag-3,fig.height=5,fig.width=5,echo=FALSE}
```
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
```{r,bag-4,fig.height=5,fig.width=5,eval=FALSE,echo=TRUE}
ggplot(iris,aes(x=Sepal.Length,
                y=Sepal.Width,
                colour=Species))+
  geom_point()
...
::: {.column width="50%"}
```{r,bag-4,fig.height=5,fig.width=5,echo=FALSE}
```
:::
::::
...
```{r,echo=TRUE,fig.height=1.7,fig.width=8}
...
```{r,fig.height=4,fig.width=5.5,echo=TRUE}
ggplot(iris)+
...
```{r,fig.height=6,fig.width=12,echo=TRUE}
...
<img src="assets/scales.png" alt="scales-syntax" style="width:50%;">

:::: {.columns}
::: {.column width="50%"}
```{r,fig.height=2.8,fig.width=5,echo=TRUE}
...
```{r,fig.height=4.6,fig.width=9,echo=FALSE}
...
```{r,fig.height=4.8,fig.width=9,echo=FALSE}
...
- [**ggforce**](https://ggforce.data-imaginist.com/): Additional features
...
- Blogs, for example; [R-Bloggers](https://www.r-bloggers.com/), [Cedric Scherer](https://www.cedricscherer.com/tags/ggplot2/) etc.  

##

![](assets/meme-end-of-pres.jpg)
