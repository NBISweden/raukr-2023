...
![](assets/high_dimensional_data.png){width="100%"}
<img align="center" width="100" height="100" src="assets/high_dimensional_data.png">


## Types of data analysis
![](assets/AmountOfData.png){width="100%"}
<img align="center" width="100" height="100" src="assets/AmountOfData.png">
...
```
```{r}
#| class-source: my_code_size_smaller
#| classes: my_code_size_smaller
...
::: {.fragment}
```{r}
#| class-source: my_code_size_tiny
#| classes: my_code_size_tiny
...
:::: {.columns}
::: {.column width="60%"}
![](assets/TrainTestSplit.png){width="100%"}
:::
::: {.column width="40%"}
