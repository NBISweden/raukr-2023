...
Please download the following file and unzip the contents before the lab. Note that this link will be inactive in 30 days.

<a class="btn btn-secondary btn-sm" href="https://xferticket.nbis.se/tickets/StROhz341wvxa6RZIADXtC9vR_xw_RVFIoAF-7yddUc/raukr-reticulate.zip/download" role="button">{{< fa download >}} raukr-reticulate.zip</a>
